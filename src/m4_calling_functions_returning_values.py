...
def run_test_sum_of_digits():
    ...
    # Test 3:
    expected = 7
    answer = sum_of_digits(331)
    print('Test 3 expected:', expected)
    print('        actual:', answer)

    # Test 4:
    expected = 16
    answer = sum_of_digits(5551)
    print('Test 4 expected:', expected)
    print('        actual:', answer)

    # Test 5:
    expected = 37
    answer = sum_of_digits(99991)
...
def digits_in_power(n, k):
    ...
    digits_power = sum_of_digits(n**k)
...
def fancy_sums_of_digits(n):
    ...
    fancy_digits = sum_of_digits(x**y)
